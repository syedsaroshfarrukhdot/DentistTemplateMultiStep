			...
			<div className="row1">
				<div className="col-xs-12">
					<div className="tooltipp">
						...
						<p clasName="animated zoomIn"  style={{animationDelay: '0.4s'}}>Bei <strong>sehr guten Leistungen im Zahnbereich erhalten Sie Zahnersatz ohne Zuzahlungen</strong> sowie kostenfreie Vorsorgeleistungen wie z.B. professionelle Zahnreinigungen.</p>
						</div>
					</div>
				</div>
			</div>
