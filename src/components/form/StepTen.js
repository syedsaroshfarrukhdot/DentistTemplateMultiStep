			...
			<div className="row1">
				<div className="col-xs-12">
					<div className="tooltipp">
						...
						<p className="animated zoomIn"  style={{animationDelay: '0.4s'}}>Anhand Ihrer Angaben <strong>haben</strong> wir nun Ihr <strong>Sparpotential und die Tarifauswahl</strong> für <strong>Ihr persönliches und unverbindliches Angebot</strong> ermittelt.</p>
						</div>
					</div>
				</div>
			</div>
