    ...
    <div className="site_wrapper1">
      <div className="form-tooltipp">
            ...
            <div className="tooltipp-text">
							<p className="animated zoomIn" style={{animationDelay: "0.4s"}}>Für eine <strong>korrekte Berechnung</strong> des Beitrags ist <strong>Ihr Berufsstatus wichtig</strong>.</p>
							<p className="animated zoomIn" style={{animationDelay: '0.4s'}}><strong>Der Beitrag unterscheidet sich je nach Berufsstatus stark.</strong></p>
						</div>
					</div>
				</div>
			</div>
