			...
			<div className="row1">
				<div className="col-xs-12">
					<div className="tooltipp">
						...
						<p className="animated zoomIn"  style={{animationDelay: '0.4s'}}>Sie können <strong>jetzt</strong> weiter ( z. B. mit Berufsstatus, gewünschte Leistungen ) <strong>Ihr Sparpotential und die Tarifauswahl optimieren</strong>.</p>
						</div>
					</div>
				</div>
			</div>
